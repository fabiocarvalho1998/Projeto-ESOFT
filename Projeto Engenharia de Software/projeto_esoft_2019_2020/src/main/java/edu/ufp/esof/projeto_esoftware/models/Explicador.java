...
public class Explicador {
    ...
    public boolean temhorario(LocalDateTime dataInicio) {
        return temhorario(dataInicio.getDayOfWeek().getValue(),dataInicio.toLocalTime());
    }

    public boolean podeAtender(Explicacao explicacao) {
        return this.temhorario(explicacao.getDataInicio()) && !this.temExplicacao(explicacao);
    }
    ...
    public static class ExplicadorBuilder {
        ...
        public ExplicadorBuilder disponibilidades(HashSet<Disponibilidade> d) {
