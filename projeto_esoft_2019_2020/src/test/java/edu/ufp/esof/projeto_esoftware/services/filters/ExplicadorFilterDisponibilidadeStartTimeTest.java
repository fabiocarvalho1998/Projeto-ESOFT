...
class ExplicadorFilterDisponibilidadeStartTimeTest {
    ...
    void Filter() {
        ...
        assertEquals(2, explicadorFilterExplicacaoStartTime.filter(explicadorSet).size);*/
